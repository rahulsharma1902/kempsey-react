...
import { faqcontent, addfaqcontent } from '../../../api/apiStorefront';
...
const FaqContentAdd = () => {
    ...
    useEffect(() => {
        const getParentCategory = async () => {
            try {
                const response = await faqcontent();
                if (response.data) {
                    setFormData({
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await addfaqcontent(data); // Use FormData in the request
