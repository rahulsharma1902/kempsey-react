...
const ProductsAdd = () => {
    ...
    const handleThumbnailChange = (imageSrc) => {
    ...
    const handleSubmit = async (e) => {
        ...
        form.append('selectedOptions', JSON.stringify(selectedOptions)); // Convert selected options to JSON string
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <form onSubmit={handleSubmit} encType="multipart/form-data">
                                            ...
                                            <div key={index} className="col-lg-2 p-2">
                                                <div className="custom-control custom-radio image-control">
                                                    <input
                                                        ...
                                                        id={`imageRadio${index}`}
                                                        checked={selectedThumbnail === preview}
                                                        onChange={() => handleThumbnailChange(preview)}
                                                    />
                                ...
                                <div className="form-group">
                                    <button type="submit" className="btn btn-lg btn-dark">Add Product</button>
                                </div>
                            </form>
                        </div>
                    </div>
